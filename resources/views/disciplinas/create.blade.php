...
@section('content')
    <div class="container mt-4">
        <div class="card shadow p-4">
            ...
            // method="POST" usado pois envia dados para criar um novo registro
            <form action="{{ route('disciplinas.store') }}" method="POST" class="space-y-4">
                ...
                // Campo para a carga horária (número)
                <div class="mb-3">
                ...
                // Campo opcional de descrição da disciplina
                <div class="mb-3">
                    <label for="descricao" class="form-label fw-semibold">Descrição</label>
                    <textarea name="descricao" id="descricao" class="form-control"></textarea>
                </div>

                // Botões: Salvar envia POST para store, Cancelar volta para index
